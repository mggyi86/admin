                ...
                <div class="tab-pane active" id="tab_0">
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form action="{{ route('backend.stocks.update', $stock->uuid) }}"
                                ...
                                <div class="form-body">
                                        ...
                                        <div class="col-md-4">
                                            <select id="restaurant" class="form-control select2" name="restaurant" required>
                                                ...
                                                @forelse($restaurants as $restaurant)
                                                    ...
                                                    @if($restaurant->name == $stock->restaurant->name)
                                                    selected="selected"
                                                    @endif
                                                    >
                                                        {{ $restaurant->name }}
                                    ...
                                    <div class="form-group{{ $errors->has('name_en') ? ' has-error ' : ''}}">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            name="name_en" value="{{ old('name_en') ? old('name_en') : $stock->name_en }}" required>
                                    ...
                                    <div class="form-group{{ $errors->has('name_mm') ? ' has-error ' : ''}}">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            name="name_mm" value="{{ old('name_mm') ? old('name_mm') : $stock->name_mm }}"
                                            required>
                                    ...
                                    <div class="form-group{{ $errors->has('net_price') ? ' has-error ' : ''}}">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            name="net_price" value="{{ old('net_price') ? old('net_price') :
                                            $stock->net_price }}" required>
                                    ...
                                    <div class="form-group{{ $errors->has('discounted_price') ? ' has-error ' : ''}}">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            old('discounted_price') : $stock->discounted_price }}" required>
