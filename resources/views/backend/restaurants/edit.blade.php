                ...
                <div class="tab-pane active" id="tab_0">
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form action="{{ route('backend.restaurants.update', $restaurant->slug) }}"
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group{{ $errors->has('name') ? ' has-error ' : ''}}">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            name="name" value="{{ old('name') ? old('name') : $restaurant->name }}" required>
                                            @if ($errors->has('name'))
                                    ...
                                    <div class="form-group{{ $errors->has('contact_name') ? ' has-error ' : ''}}">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            name="contact_name" value="{{ old('contact_name') ? old('contact_name') :
                                            $restaurant->contact_name }}" required>
                                    ...
                                    <div class="form-group{{ $errors->has('phone') ? ' has-error ' : ''}}">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            name="phone" value="{{ old('phone') ? old('phone') : $restaurant->phone }}"
                                            required>
                                            @if ($errors->has('phone'))
                                    ...
                                    <div class="form-group{{ $errors->has('email') ? ' has-error ' : ''}}">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            name="email" value="{{ old('email') ? old('email') : $restaurant->email }}"
                                            required>
                                            @if ($errors->has('email'))
                                    ...
                                    <div class="form-group{{ $errors->has('address') ? ' has-error ' : ''}}">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            name="address" value="{{ old('address') ? old('address') :
                                    ...
                                    <div class="form-group{{ $errors->has('service_charges') ? ' has-error ' : ''}}">
                                        <label for="service_charges" class="col-md-3 control-label">
                                            Service Charges(%)
                                        </label>
                                        <div class="col-md-4">
                                            <input type="text" class="form-control" placeholder="Service Charges(%)"
                                            name="service_charges" value="{{ old('service_charges') ?
                                            old('service_charges') : $restaurant->service_charges }}" required>
                                    ...
                                    <div class="form-group{{ $errors->has('packagings') ? ' has-error ' : ''}}">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            name="packagings" value="{{ old('packagings') ? old('packagings') :
                                            $restaurant->packagings }}" required>
                                    ...
                                    <div class="form-group{{ $errors->has('opening_time') ? ' has-error ' : ''}}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group">
                                                ...
                                                name="opening_time" value="{{ old('opening_time') ? old('opening_time') :
                                    ...
                                    <div class="form-group{{ $errors->has('closing_time') ? ' has-error ' : ''}}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group">
                                                <input type="text" class="form-control timepicker timepicker-24"
                                                name="closing_time" value="{{ old('closing_time') ? old('closing_time') :
