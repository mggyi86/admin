                ...
                <div class="tab-pane active" id="tab_0">
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form action="{{ route('backend.townships.store') }}" class="form-horizontal" method="POST">
                                @csrf
                                <div class="form-body">
                                    ...
                                    <div class="form-group{{ $errors->has('name') ? ' has-error ' : ''}}">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" class="form-control" placeholder="Township Name"
                                ...
                                <div class="form-actions">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-4">
                                            ...
                                            <a type="button" class="btn default" href="{{ route('backend.townships.index') }}">Cancel</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
