        ...
        <div class="content">
            ...
            <form class="login-form" action="{{ route('login') }}" method="POST">
                ...
                <div class="form-group{{ $errors->has('email') ? ' has-error ' : ''}}">
                    ...
                    <input id="email" class="form-control form-control-solid placeholder-no-fix
                    {{ $errors->has('email') ? ' is-invalid' : '' }}" type="email" autocomplete="off"
                ...
                <div class="form-group">
                    ...
                    <input id="password" class="form-control form-control-solid placeholder-no-fix
                    {{ $errors->has('password') ? ' is-invalid' : '' }}"
                    type="password" autocomplete="off" placeholder="{{ __('Password') }}" name="password" required />
                ...
                <div class="form-actions">
                    ...
                    <label class="rememberme check mt-checkbox mt-checkbox-outline">
                        ...
                        {{ old('remember') ? 'checked' : '' }} />{{ __('Remember') }}
                        <span></span>
                    </label>
...
{{--             <form class="register-form" action="index.html" method="post">
        ...
        <div class="copyright"> 2018 © Metronic. Admin Dashboard. </div>
        <!--[if lt IE 9]>
