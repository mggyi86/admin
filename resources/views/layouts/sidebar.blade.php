<div class="page-sidebar-wrapper">
    ...
    <div class="page-sidebar navbar-collapse collapse">
        ...
        <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
            ...
            <li class="nav-item{{ request()->url() == url('form') ? ' active open ' : '' }}">
                <a href="{{ url('form') }}" class="nav-link nav-toggle">
                    <i class="icon-puzzle"></i>
                    <span class="title">Form</span>
                    @if(request()->url() == url('form'))
                        <span class="selected"></span>
                    @endif
                </a>
            </li>
            <li class="nav-item{{ request()->url() == route('backend.divisions.index') ? ' active open ' : '' }}">
                ...
                {{--  <ul class="sub-menu">
                    <li class="nav-item{{ request()->url() == route('backend.division.show') ? ' active open ' : '' }}">
                        <a href="ui_colors.html" class="nav-link ">
                            <span class="title">View Division</span>
                        </a>
                        @if(request()->url() == route('backend.division.show'))
                            <span class="selected"></span>
                        @endif
                    </li>
                </ul>  --}}
            ...
            <li class="nav-item{{ request()->url() == route('backend.merchants.index') ? ' active open ' : '' }}">
                <a href="{{ route('backend.merchants.index') }}" class="nav-link nav-toggle">
                    <i class="icon-puzzle"></i>
                    <span class="title">Merchant</span>
                    @if(request()->url() == route('backend.merchants.index'))
                        <span class="selected"></span>
                        {{--  <span class="arrow open"></span>  --}}
                    @endif
                </a>
            </li>
            <li class="nav-item{{ request()->url() == route('backend.restaurants.index') ? ' active open ' : '' }}">
                <a href="{{ route('backend.restaurants.index') }}" class="nav-link nav-toggle">
                    <i class="icon-puzzle"></i>
                    <span class="title">Restaurant</span>
                    @if(request()->url() == route('backend.restaurants.index'))
                        <span class="selected"></span>
                        {{--  <span class="arrow open"></span>  --}}
                    @endif
                </a>
            </li>
            <li class="nav-item{{ request()->url() == route('backend.stocks.index') ? ' active open ' : '' }}">
                <a href="{{ route('backend.stocks.index') }}" class="nav-link nav-toggle">
                    <i class="icon-puzzle"></i>
                    <span class="title">Stock</span>
                    @if(request()->url() == route('backend.stocks.index'))
                        <span class="selected"></span>
                        {{--  <span class="arrow open"></span>  --}}
                    @endif
                </a>
